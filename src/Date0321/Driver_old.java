...
public class Driver_old {
    ...
    public ArrayList<String> parseMovie(String responseBody) {
            ...
            if(hasResponse) {//所以如果有資料就是TRUE
                ...
                for(Object obj : movies) {
                    ...
                    result.add(" > " + aMovie.getString("Title") + "(" +
                            aMovie.getString("Year") + ")");
                }
            }
            return result;//FASLE
...
//        ArrayList<String> movieList = driver.parseMovie(result);//放到function內 去執行
//    }
}